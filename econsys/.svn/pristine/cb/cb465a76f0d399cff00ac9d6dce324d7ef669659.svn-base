...
public class CommonUtils {
	...
	//explicit wait
			public void waitForElement(WebElement ElementToBePresent,int timeToWaitInSeconds){
				try{
					Thread.sleep(1000);
					...
					System.out.println("Unable To Execute waitForElement Method  "+e);
				}
			}
	//select By Index
