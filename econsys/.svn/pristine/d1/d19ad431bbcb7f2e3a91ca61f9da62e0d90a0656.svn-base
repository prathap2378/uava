...
private WebElement exe_cp5_sw;

public WebElement getExe_cp5_sw() {
	return exe_cp5_sw;
}
@FindBy(xpath="//select[@id='explicit_approval_operation']")
private WebElement exe_cp5_sw_OperatonAcceptance;
public WebElement getExe_cp5_sw_OperatonAcceptance() {
	return exe_cp5_sw_OperatonAcceptance;
}
