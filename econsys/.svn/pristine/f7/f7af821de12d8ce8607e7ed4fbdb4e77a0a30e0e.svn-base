...
import com.econsys.SmallWorks.projectMethods;
...
public class TasksCP5toCP9 extends Driver {
	...
	projectMethods proMethod=PageFactory.initElements(Driver.driver(), projectMethods.class);
	/*import classes*/
  ...
  public void deveryreview() throws IOException, InterruptedException{
	  ...
	  proMethod.uploadFile("Milestone Document 1.txt");
	  driver.findElement(By.xpath("//a[starts-with(@id,'img_cmt_SUBPROCMDRGriddoc')]")).click();
	  Thread.sleep(1000);
	  driver.findElement(By.xpath("//div[starts-with(@id,'dropzone-SUBPROCMDRGriddoc')]")).click();
	  proMethod.uploadFile("Plan document 1.txt");
	  driver.findElement(By.id("mdrRiskRegisterupdated-dropzone")).click();
	  proMethod.uploadFile("Updated Risk and Opportunity Register 2.txt");
	  ...
	  Thread.sleep(1000);
	  driver.findElement(By.xpath("//div[starts-with(@id,'dropzone-SUBPROCMDRGriddoc')]")).click();
	  proMethod.uploadFile("Plan document 2.txt");
	  driver.findElement(By.id("mdrRiskRegisterupdated-dropzone")).click();
	  proMethod.uploadFile("Updated Risk and Opportunity Register 2.txt");
	  driver.findElement(By.id("mdrPanelProductionSchedule-dropzone")).click();
	  ...
	  Thread.sleep(1000);
	  driver.findElement(By.xpath("//div[starts-with(@id,'dropzone-SUBPROCMDRGriddoc')]")).click();
	  proMethod.uploadFile("Plan document 3.txt");
	  driver.findElement(By.id("mdrRiskRegisterupdated-dropzone")).click();
	  proMethod.uploadFile("Updated Risk and Opportunity Register 3.txt");
	  driver.findElement(By.id("mdrPanelProductionSchedule-dropzone")).click();
