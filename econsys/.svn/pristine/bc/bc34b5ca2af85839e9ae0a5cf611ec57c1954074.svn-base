...
import POC.Econsys_Auto.Listener;
 ...
 */
public class Donot_Proceed_and_Reject extends Driver{
...
@Test
public void cp2_doNotProceed() throws InterruptedException, AWTException, IOException {
...
@Test(priority=1)
public void cp3_doNotProceed() throws IOException, InterruptedException, AWTException {
...
@Test(priority=2)
public void cp4_doNotProceed() throws IOException, InterruptedException, AWTException {
...
@Test(priority=3)
public void cp5_doNotProceed() throws IOException, InterruptedException, AWTException {
	  System.out.println("cp5_doNotProceed");
	  login.url();
	  sw.quoteForm();
	  commonutils.selectByVisibleText(quote_form.getExpliciteapprovalatgateway2(), "No");
	  ab.getSubmitbutton().click();
...
public void submitQuote_CP4() throws IOException, InterruptedException{
    ...
    //Cp4 explicit Approval
	  ...
	  commonutils.waitForPageToLoad();
	  driver().findElement(By.xpath("//tr[td[@title="+ev.projectName()+"]]/td[13]/a[text()='Open']")).click();
	  ...
	  login.loginSL();
	  b.projectname();
	  ab.getComments().sendKeys("Customet commecement submit");
	  commonutils.selectByVisibleText(ccq_Ui.getExeCP4(), "Yes");
	  ccq_Ui.getSubmit().click();
	  login.logout();
