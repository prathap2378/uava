...
import com.UIobjectrepositary.in.SDapprTandCOPacceptanceui;
...
public class TaskCP3CP4 extends Driver{
  ...
  public void customercommit() throws IOException, InterruptedException{
		 ...
		 cu.selectByVisibleText(ccq.getContract_Value(), contract_Value);
		 
		 if(final_quoted_scope.equals("No")||docs_Refrenced.equals("No")||terms_and_conditions.equals("No")||project_Start_Date.equals("No")||project_End_Date.equals("No")||contract_Value.equals("No")){
				ccq.getReseon_for_No().sendKeys("Reseaon for No"); 
		 }
		 
		 else if(final_quoted_scope.equals("Yes")&&docs_Refrenced.equals("Yes")&&terms_and_conditions.equals("Yes")&&project_Start_Date.equals("Yes")&&project_End_Date.equals("Yes")&&contract_Value.equals("Yes")){
		 ...
		 if(final_quoted_scope.equals("Yes")&&docs_Refrenced.equals("Yes")&&terms_and_conditions.equals("Yes")&&project_Start_Date.equals("Yes")&&project_End_Date.equals("Yes")&&contract_Value.equals("Yes")){
